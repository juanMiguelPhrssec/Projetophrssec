            ...
            <x-adminlte-card title="Registrar nova empresa" theme="light" theme-mode="full" class="elevation-3 text-black"
                    ...
                    @csrf
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                {{-- inputs --}}
                                <x-adminlte-input name="nome_da_empresa" placeholder="Nome Completo"
                                            label="Nome Completo" value="{{ old('nome_da_empresa') }}" />
                              
                                            
                                <x-adminlte-input name="cnpj" placeholder="000.000.000/0000-00"
                                            label="cnpj" data-mask="000.000.000/0000-00" value="{{ old('cnpj') }}" />
